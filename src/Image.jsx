...
export default function Image({pokemon}){
  ...
  return(
    <div className= "flex flex-row p-2 h-60 lg:flex-row lg:h-80 rounded-t-xl" style={{backgroundColor: lightenColor(getTypeColor(pokemon.types[0]))}} >
      ...
      <img className="mx-auto w-50 lg:w-70" src={pokemon.sprite} alt={pokemon.name} loading="lazy"/>
    </div>
  )
}